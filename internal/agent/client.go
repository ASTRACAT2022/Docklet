	...
	case "docker_run":
		if a.DockerCli == nil {
			...
			if len(cmd.Args) < 1 {
				...
				reader, err := a.DockerCli.ImagePull(context.Background(), imageName, types.ImagePullOptions{})
				if err != nil {
					...
					if err != nil {
						...
						// 3. Start Container
						if err := a.DockerCli.ContainerStart(context.Background(), resp.ID, types.ContainerStartOptions{}); err != nil {
